                      ...
                      <div key={e.id} className="p-4 flex justify-between items-center hover:bg-white/[0.02] transition-colors group">
                        ...
                        <div className="flex gap-4 items-center">
                          <div className="flex gap-2">
                            <Link to={`/api/stream/${e.id}`} className="text-[9px] font-black text-blue-500 hover:text-blue-400 uppercase tracking-tighter transition-colors">Stream</Link>
                            <span className="text-slate-800">|</span>
                            <Link to={`/api/audit/${e.id}`} className="text-[9px] font-black text-indigo-500 hover:text-indigo-400 uppercase tracking-tighter transition-colors">Audit</Link>
                          </div>
